...
#ifndef TCHECKER_CLOCKBOUNDS_SOLVER_HA_HH
#define TCHECKER_CLOCKBOUNDS_SOLVER_HA_HH
...
public:
  ...
  */
  df_solver_t(tchecker::ta_ha::system_t const & system);
  ...
  */
  df_solver_t(tchecker::clockbounds_ha::df_solver_t const & solver);
  ...
  */
  df_solver_t(tchecker::clockbounds_ha::df_solver_t && solver);
  ...
  */
  ...
  \return this
  */
  tchecker::clockbounds_ha::df_solver_t & operator=(tchecker::clockbounds_ha::df_solver_t const & solver);
  ...
  \return this
  */
  tchecker::clockbounds_ha::df_solver_t & operator=(tchecker::clockbounds_ha::df_solver_t && solver);
...
void add_location_constraints(tchecker::typed_expression_t const & inv, tchecker::loc_id_t loc,
                              tchecker::clockbounds_ha::df_solver_t & solver);
...
void add_edge_constraints(tchecker::typed_expression_t const & guard, tchecker::typed_statement_t const & stmt,
                          tchecker::loc_id_t src, tchecker::loc_id_t tgt, tchecker::clockbounds_ha::df_solver_t & solver);
