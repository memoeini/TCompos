...
public:
  ...
  inline std::unordered_map<std::string, std::shared_ptr<tchecker::parsing::clock_declaration_t>> const & get_clocks () const {
    return _clocks;
  }

  inline std::unordered_map<std::string, std::shared_ptr<tchecker::parsing::event_declaration_t>> const & get_events () const {
    return _events;
  }

  inline std::vector<std::shared_ptr<tchecker::parsing::sync_declaration_t>> const & get_syncs () const {
    return _syncs;
  }
...
private:
  ...
  std::vector<std::shared_ptr<tchecker::parsing::sync_declaration_t>> _syncs;    /*!< sync declaration index */
};
