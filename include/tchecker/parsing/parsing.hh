...
/*!
 \brief Parser for systems from a buffer
 */
std::shared_ptr<tchecker::parsing::system_declaration_t> parse_system_declaration_from_buffer(std::string const & buffer, std::string const & filename);
