...
#ifndef TCHECKER_TA_ALLOCATORS_HA_HH
#define TCHECKER_TA_ALLOCATORS_HA_HH
...
public:
   ...
   */
  state_pool_allocator_t(tchecker::ta_ha::details::state_pool_allocator_t<STATE> const &) = delete;

  /*!
   \brief Move constructor (deleted)
   */
  state_pool_allocator_t(tchecker::ta_ha::details::state_pool_allocator_t<STATE> &&) = delete;
   ...
   */
  tchecker::ta_ha::details::state_pool_allocator_t<STATE> &
  operator=(tchecker::ta_ha::details::state_pool_allocator_t<STATE> const &) = delete;

  /*!
   \brief Move-assignment operator (deleted)
   */
  tchecker::ta_ha::details::state_pool_allocator_t<STATE> &
  operator=(tchecker::ta_ha::details::state_pool_allocator_t<STATE> &&) = delete;
  ...
  */
  ...
  {
    return tchecker::ta_ha::details::state_pool_allocator_t<STATE>::construct_from_state(s);
  }
...
class transition_pool_allocator_t : private tchecker::syncprod::details::transition_pool_allocator_t<TRANSITION> {
  static_assert(std::is_base_of<tchecker::ta_ha::transition_t, TRANSITION>::value, "");
 ...
 */
class state_pool_allocator_t final : public tchecker::ta_ha::details::state_pool_allocator_t<tchecker::ta::shared_state_t> {
public:
  using tchecker::ta_ha::details::state_pool_allocator_t<tchecker::ta::shared_state_t>::state_pool_allocator_t;
};
...
class transition_pool_allocator_t final
    : public tchecker::ta_ha::details::transition_pool_allocator_t<tchecker::ta_ha::shared_transition_t> {
public:
  using tchecker::ta_ha::details::transition_pool_allocator_t<tchecker::ta_ha::shared_transition_t>::transition_pool_allocator_t;
};
...
#endif // TCHECKER_TA_ALLOCATORS_HA_HH
