...
#ifndef TCHECKER_TA_HA_HH
#define TCHECKER_TA_HA_HH
 ...
 */
inline tchecker::ta_ha::initial_range_t initial_edges(tchecker::ta_ha::system_t const & system)
{
...
tchecker::state_status_t initial(tchecker::ta_ha::system_t const & system,
                                 ...
                                 tchecker::ta_ha::initial_value_t const & initial_range);
...
*/
inline tchecker::state_status_t initial(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t & s,
                                        tchecker::ta_ha::transition_t & t, tchecker::ta_ha::initial_value_t const & v)
{
  return tchecker::ta_ha::initial(system, s.vloc_ptr(), s.intval_ptr(), t.vedge_ptr(), t.tgt_invariant_container(), v);
}
...
*/
using final_range_t = tchecker::range_t<tchecker::ta_ha::final_iterator_t, tchecker::end_iterator_t>;
 ...
 */
tchecker::ta_ha::final_range_t final_edges(tchecker::ta_ha::system_t const & system, boost::dynamic_bitset<> const & labels);
...
tchecker::state_status_t final(tchecker::ta_ha::system_t const & system,
                               ...
                               tchecker::intrusive_shared_ptr_t<tchecker::shared_vedge_t> const & vedge,
                               tchecker::clock_constraint_container_t & invariant,
                               tchecker::ta_ha::final_value_t const & final_value);
...
\throw std::invalid_argument : if s and v have incompatible sizes
*/
inline tchecker::state_status_t final(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t & s,
                                      tchecker::ta_ha::transition_t & t, tchecker::ta_ha::final_value_t const & v)
{
  return tchecker::ta_ha::final(system, s.vloc_ptr(), s.intval_ptr(), t.vedge_ptr(), t.tgt_invariant_container(), v);
}
 ...
 */
inline tchecker::ta_ha::outgoing_edges_range_t
...
tchecker::state_status_t next(tchecker::ta_ha::system_t const & system,
                              ...
                              std::vector<unsigned> & intvarconstr,
                              ...
                              tchecker::ta_ha::outgoing_edges_value_t const & edges);
...
*/
inline tchecker::state_status_t next(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t & s,
                                     tchecker::ta_ha::transition_t & t, tchecker::ta_ha::outgoing_edges_value_t const & v)
{
  return tchecker::ta_ha::next(system, s.vloc_ptr(), s.intval_ptr(), t.vedge_ptr(), t.src_invariant_container(),
                            t.guard_container(), t.intvar_guard_container(), t.reset_container(), t.intvar_set_container(), t.tgt_invariant_container(), v);
}
...
*/
using incoming_edges_range_t = tchecker::range_t<tchecker::ta_ha::incoming_edges_iterator_t, tchecker::end_iterator_t>;
 ...
 */
tchecker::ta_ha::incoming_edges_range_t
...
tchecker::state_status_t prev(tchecker::ta_ha::system_t const & system,
                              ...
                              std::vector<std::pair<tchecker::variable_id_t, tchecker::variable_id_t>> & intvar_set,
                              tchecker::clock_constraint_container_t & tgt_invariant,
                              tchecker::ta_ha::incoming_edges_value_t const & v);
...
\throw std::invalid_argument : if s and v have incompatible size
*/
inline tchecker::state_status_t prev(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t & s,
                                     tchecker::ta_ha::transition_t & t, tchecker::ta_ha::incoming_edges_value_t const & v)
{
  return tchecker::ta_ha::prev(system, s.vloc_ptr(), s.intval_ptr(), t.vedge_ptr(), t.src_invariant_container(),
                            t.guard_container(), t.intvar_guard_container(), t.reset_container(), t.intvar_set_container(), t.tgt_invariant_container(), v);
}
 ...
 */
bool delay_allowed(tchecker::ta_ha::system_t const & system, tchecker::vloc_t const & vloc);
 ...
 */
boost::dynamic_bitset<> delay_allowed(tchecker::ta_ha::system_t const & system, tchecker::reference_clock_variables_t const & r,
 ...
 */
boost::dynamic_bitset<> sync_refclocks(tchecker::ta_ha::system_t const & system, tchecker::reference_clock_variables_t const & r,
...
/*!
  ...
  */
boost::dynamic_bitset<> labels(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t const & s);
...
/*!
 ...
 \return true
*/
bool is_valid_final(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t const & s);
...
/*!
 ...
 false otherwise
*/
bool is_initial(tchecker::ta_ha::system_t const & system, tchecker::intval_t const & v);
...
*/
bool is_initial(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t const & s);
...
/*!
 ...
 added to map m
 */
void attributes(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t const & s, std::map<std::string, std::string> & m);
 ...
 */
void attributes(tchecker::ta_ha::system_t const & system, tchecker::ta_ha::transition_t const & t,
...
/*!
 ...
 attributes["vloc"]
*/
inline tchecker::state_status_t initialize(tchecker::ta_ha::system_t const & system, tchecker::ta::state_t & s,
                                           tchecker::ta_ha::transition_t & t,
                                           std::map<std::string, std::string> const & attributes)
{
  return tchecker::ta_ha::initialize(system, s.vloc_ptr(), s.intval_ptr(), t.vedge_ptr(), t.src_invariant_container(), attributes);
}
...
class ta_t final : public tchecker::ts::fwd_t<tchecker::ta::state_sptr_t, tchecker::ta::const_state_sptr_t,
                                              tchecker::ta_ha::transition_sptr_t, tchecker::ta_ha::const_transition_sptr_t>,
                   ...
                   public tchecker::ts::fwd_impl_t<tchecker::ta::state_sptr_t, tchecker::ta::const_state_sptr_t,
                                                   tchecker::ta_ha::transition_sptr_t, tchecker::ta_ha::const_transition_sptr_t,
                                                   tchecker::ta_ha::initial_range_t, tchecker::ta_ha::outgoing_edges_range_t,
                                                   tchecker::ta_ha::initial_value_t, tchecker::ta_ha::outgoing_edges_value_t>,
                   public tchecker::ts::bwd_impl_t<tchecker::ta::state_sptr_t, tchecker::ta::const_state_sptr_t,
                                                   tchecker::ta_ha::transition_sptr_t, tchecker::ta_ha::const_transition_sptr_t,
                                                   tchecker::ta_ha::final_range_t, tchecker::ta_ha::incoming_edges_range_t,
                                                   tchecker::ta_ha::final_value_t, tchecker::ta_ha::incoming_edges_value_t>,
                   public tchecker::ts::builder_t<tchecker::ta::state_sptr_t, tchecker::ta_ha::transition_sptr_t>,
                   public tchecker::ts::inspector_t<tchecker::ta::const_state_sptr_t, tchecker::ta_ha::const_transition_sptr_t>,
                   public tchecker::ts::sharing_t<tchecker::ta::state_sptr_t, tchecker::ta_ha::transition_sptr_t> {
public:
  // Inherited types
  ...
  using bwd_impl_t = tchecker::ts::bwd_impl_t<tchecker::ta::state_sptr_t, tchecker::ta::const_state_sptr_t,
                                              ...
                                              tchecker::ta_ha::final_range_t, tchecker::ta_ha::incoming_edges_range_t,
                                              tchecker::ta_ha::final_value_t, tchecker::ta_ha::incoming_edges_value_t>;
  using builder_t = tchecker::ts::builder_t<tchecker::ta::state_sptr_t, tchecker::ta_ha::transition_sptr_t>;
  using inspector_t = tchecker::ts::inspector_t<tchecker::ta::const_state_sptr_t, tchecker::ta_ha::const_transition_sptr_t>;
  using sharing_t = tchecker::ts::sharing_t<tchecker::ta::state_sptr_t, tchecker::ta_ha::transition_sptr_t>;
   ...
   */
  ta_t(std::shared_ptr<tchecker::ta_ha::system_t const> const & system, enum tchecker::ts::sharing_type_t sharing_type,
       std::size_t block_size, std::size_t table_size);

  /*!
   \brief Copy constructor (deleted)
   */
  ta_t(tchecker::ta_ha::ta_t const &) = delete;

  /*!
   \brief Move constructor (deleted)
   */
  ta_t(tchecker::ta_ha::ta_t &&) = delete;
   ...
   */
  tchecker::ta_ha::ta_t & operator=(tchecker::ta_ha::ta_t const &) = delete;

  /*!
   \brief Move-assignment operator (deleted)
   */
  tchecker::ta_ha::ta_t & operator=(tchecker::ta_ha::ta_t &&) = delete;
  ...
  */
   ...
   */
  virtual void attributes(tchecker::ta_ha::const_transition_sptr_t const & t, std::map<std::string, std::string> & m) const;
  ...
  */
  virtual void share(tchecker::ta_ha::transition_sptr_t & t);
...
private:
  ...
  tchecker::ta_ha::state_pool_allocator_t _state_allocator;           /*!< Pool allocator of states */
  tchecker::ta_ha::transition_pool_allocator_t _transition_allocator; /*! Pool allocator of transitions */
};
