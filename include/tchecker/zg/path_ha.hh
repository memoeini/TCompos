...
#ifndef TCHECKER_ZG_PATH_HA_HH
#define TCHECKER_ZG_PATH_HA_HH
...
public:
  ...
  */
  edge_t(tchecker::zg_ha::const_transition_sptr_t const & t);

  /*!
   \brief Constructor
   \post this keeps a pointer on t
  */
  edge_t(tchecker::zg_ha::transition_sptr_t const & t);

  /*!
   \brief Copy constructor
  */
  edge_t(tchecker::zg_ha::path::symbolic::edge_t const & e);

  /*!
   \brief Move constructor
  */
  edge_t(tchecker::zg_ha::path::symbolic::edge_t && e);
  ...
  */
  tchecker::zg_ha::path::symbolic::edge_t & operator=(tchecker::zg_ha::path::symbolic::edge_t const & e);

  /*!
   \brief Move assignment operator
  */
  tchecker::zg_ha::path::symbolic::edge_t & operator=(tchecker::zg_ha::path::symbolic::edge_t && e);

  /*!
   \brief Accessor
   \return a pointer to the transition in this edge
  */
  inline tchecker::zg_ha::const_transition_sptr_t const & transition_ptr() const { return _t; }

  /*!
   \brief Accessor
   \return the transition in this edge
  */
  inline tchecker::zg_ha::transition_t const & transition() const { return *_t; }

private:
  tchecker::zg_ha::const_transition_sptr_t _t; /*!< Zone graph transition */
};
...
*/
class finite_path_t : public tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                                                         tchecker::zg_ha::path::symbolic::edge_t> {
public:
  /*!
   \brief Constructor
  ...
  */
  using tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                                    tchecker::zg_ha::path::symbolic::edge_t>::finite_path_t;

  using tchecker::graph::finite_path_t<tchecker::zg_ha::path::symbolic::node_t, tchecker::zg_ha::path::symbolic::edge_t>::attributes;

  /*!
   \brief Accessor
   \return Underlying zone graph
  */
  inline tchecker::zg_ha::zg_t & zg() const
  {
    return tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                                       tchecker::zg_ha::path::symbolic::edge_t>::ts();
  }
  ...
  */
  inline std::shared_ptr<tchecker::zg_ha::zg_t> zg_ptr() const
  {
    return tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                                       tchecker::zg_ha::path::symbolic::edge_t>::ts_ptr();
  }
...
protected:
  ...
  */
  virtual void attributes(tchecker::zg_ha::path::symbolic::node_t const & n, std::map<std::string, std::string> & m) const;
  ...
  /*!
   ...
   \param m : a map (key, value) of attributes
  */
  virtual void attributes(tchecker::zg_ha::path::symbolic::edge_t const & e, std::map<std::string, std::string> & m) const;
};
...
*/
std::ostream & dot_output(std::ostream & os, tchecker::zg_ha::path::symbolic::finite_path_t const & path,
...
*/
class lasso_path_t : public tchecker::ts::lasso_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                                                       tchecker::zg_ha::path::symbolic::edge_t> {
public:
  /*!
   \brief Constructor
  ...
  */
  using tchecker::ts::lasso_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                                   tchecker::zg_ha::path::symbolic::edge_t>::lasso_path_t;

  using tchecker::graph::lasso_path_t<tchecker::zg_ha::path::symbolic::node_t, tchecker::zg_ha::path::symbolic::edge_t>::attributes;
  ...
  */
  inline tchecker::zg_ha::zg_t & zg() const
  {
    return tchecker::ts::lasso_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                                      tchecker::zg_ha::path::symbolic::edge_t>::ts();
  }
...
*/
class node_t : public tchecker::zg_ha::path::symbolic::node_t {
public:
  /*!
  \brief Constructor
  \param s : a zone graph state
...
/*!
 ...
 \brief Type of edge on a path in a zone graph
*/
class edge_t : public tchecker::zg_ha::path::symbolic::edge_t {
public:
  /*!
   \brief Constructor
  ...
  */
  edge_t(tchecker::zg_ha::const_transition_sptr_t const & t, tchecker::clock_rational_value_t delay);
  ...
  /*!
   ...
   \throw std::invalid_argument : if delay < 0
  */
  edge_t(tchecker::zg_ha::transition_sptr_t const & t, tchecker::clock_rational_value_t delay);
  ...
  /*!
   ...
   \throw std::invalid_argument : if delay < 0
  */
  edge_t(std::tuple<tchecker::zg_ha::const_transition_sptr_t, tchecker::clock_rational_value_t> const & t);
  ...
  /*!
   ...
   \throw std::invalid_argument : if delay < 0
  */
  edge_t(std::tuple<tchecker::zg_ha::transition_sptr_t, tchecker::clock_rational_value_t> const & t);

  /*!
   \brief Copy constructor
  */
  edge_t(tchecker::zg_ha::path::concrete::edge_t const & e) = default;

  /*!
   \brief Move constructor
  */
  edge_t(tchecker::zg_ha::path::concrete::edge_t && e) = default;
  ...
  */
  ...
  /*!
   ...
   \post this point to the same transition as e
  */
  tchecker::zg_ha::path::concrete::edge_t & operator=(tchecker::zg_ha::path::concrete::edge_t const & e) = default;

  /*!
   \brief Move assignment operator
  */
  tchecker::zg_ha::path::concrete::edge_t & operator=(tchecker::zg_ha::path::concrete::edge_t && e) = default;

  using tchecker::zg_ha::path::symbolic::edge_t::transition;
  using tchecker::zg_ha::path::symbolic::edge_t::transition_ptr;
...
*/
class finite_path_t : public tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::concrete::node_t,
                                                         tchecker::zg_ha::path::concrete::edge_t> {
public:
  /*!
   \brief Constructor
   \param zg : a zone graph
   ...
   \note all nodes and edges added to this path shall be built from states and transitions in zg
  */
  finite_path_t(std::shared_ptr<tchecker::zg_ha::zg_t> const & zg, std::size_t clockval_alloc_nb);

  /*!
   \brief Copy constructor
  */
  finite_path_t(tchecker::zg_ha::path::concrete::finite_path_t const &) = delete;

  /*!
   \brief Move constructor
  */
  finite_path_t(tchecker::zg_ha::path::concrete::finite_path_t &&) = delete;
  ...
  */
  ...
  /*!
   \brief Assignment operator
  */
  tchecker::zg_ha::path::concrete::finite_path_t & operator=(tchecker::zg_ha::path::concrete::finite_path_t const &) = delete;

  /*!
   \brief Move-assignment operator
  */
  tchecker::zg_ha::path::concrete::finite_path_t & operator=(tchecker::zg_ha::path::concrete::finite_path_t &&) = delete;
  ...
  */
   ...
   */
  void extend_back(tchecker::zg_ha::const_transition_sptr_t const & t, tchecker::clock_rational_value_t delay,
  ...
  /*!
   ...
   \throw see tchecker::zg::path::concrete::edge_t
   */
  void extend_front(tchecker::zg_ha::const_transition_sptr_t const & t, tchecker::clock_rational_value_t delay,
                    tchecker::zg::const_state_sptr_t const & s, tchecker::clockval_t const & clockval, bool initial = false,
                    bool final = false);

  using tchecker::graph::finite_path_t<tchecker::zg_ha::path::concrete::node_t, tchecker::zg_ha::path::concrete::edge_t>::attributes;
...
protected:
  /*!
   ...
   \param m : a map (key, value) of attributes
  */
  virtual void attributes(tchecker::zg_ha::path::concrete::node_t const & n, std::map<std::string, std::string> & m) const;
  ...
  /*!
   ...
   \param m : a map (key, value) of attributes
  */
  virtual void attributes(tchecker::zg_ha::path::concrete::edge_t const & e, std::map<std::string, std::string> & m) const;
...
/*!
 ...
 \return os after output
*/
std::ostream & dot_output(std::ostream & os, tchecker::zg_ha::path::concrete::finite_path_t const & path,
                          std::string const & name);
