...
#ifndef TCHECKER_ZG_TRANSITION_HA_HH
#define TCHECKER_ZG_TRANSITION_HA_HH
 ...
 */
class transition_t : public tchecker::ta_ha::transition_t {
public:
  using tchecker::ta_ha::transition_t::transition_t;
};
...
/*!
 ...
 \return see tchecker::ta::operator!= on transitions
 */
inline bool operator!=(tchecker::zg_ha::transition_t const & t1, tchecker::zg_ha::transition_t const & t2) { return !(t1 == t2); }
 ...
 */
std::size_t hash_value(tchecker::zg_ha::transition_t const & t);
 ...
 */
std::size_t shared_hash_value(tchecker::zg_ha::transition_t const & t);
 ...
 */
using shared_transition_t = tchecker::make_shared_t<tchecker::zg_ha::transition_t>;

/*!
\brief Type of pointer to shared transition
*/
using transition_sptr_t = tchecker::intrusive_shared_ptr_t<tchecker::zg_ha::shared_transition_t>;

/*!
\brief Type of pointer to shared const transition
*/
using const_transition_sptr_t = tchecker::intrusive_shared_ptr_t<tchecker::zg_ha::shared_transition_t const>;
 ...
 */
template <> class allocation_size_t<tchecker::zg_ha::transition_t> {
public:
  /*!
  ...
  {
    return sizeof(tchecker::zg_ha::transition_t);
  }
};

} // end of namespace tchecker

#endif // TCHECKER_ZG_TRANSITION_HA_HH
