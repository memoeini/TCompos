...
#ifndef TCHECKER_ZG_COMPOS_HH
#define TCHECKER_ZG_COMPOS_HH
...
#include "tchecker/zg/extrapolation_compos.hh"
 ...
 */
inline tchecker::zg_compos::initial_range_t initial_edges(tchecker::ta::system_t const & system)
{
...
inline tchecker::state_status_t initial(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                        ...
                                        tchecker::zg_compos::extrapolation_t & extrapolation, tchecker::zg_compos::initial_value_t const & v)
{
  return tchecker::zg_compos::initial(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
 ...
 */
inline tchecker::zg_compos::final_range_t final_edges(tchecker::ta::system_t const & system, boost::dynamic_bitset<> const & labels)
{
...
inline tchecker::state_status_t final(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                      tchecker::zg::transition_t & t, tchecker::zg::semantics_t & semantics,
                                      tchecker::zg_compos::extrapolation_t & extrapolation, tchecker::zg_compos::final_value_t const & v)
{
  return tchecker::zg_compos::final(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
                             semantics, extrapolation, v);
}
 ...
 */
inline tchecker::zg_compos::outgoing_edges_range_t
...
tchecker::state_status_t next(tchecker::ta::system_t const & system,
                              ...
                              tchecker::zg_compos::extrapolation_t & extrapolation,
                              tchecker::zg_compos::outgoing_edges_value_t const & edges);
...
inline tchecker::state_status_t next(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                     tchecker::zg::transition_t & t, tchecker::zg::semantics_t & semantics,
                                     tchecker::zg_compos::extrapolation_t & extrapolation,
                                     tchecker::zg_compos::outgoing_edges_value_t const & v)
{
  return tchecker::zg_compos::next(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
 ...
 */
inline tchecker::zg_compos::incoming_edges_range_t
...
tchecker::state_status_t prev(tchecker::ta::system_t const & system,
                              ...
                              tchecker::clock_constraint_container_t & tgt_invariant, tchecker::zg::semantics_t & semantics,
                              tchecker::zg_compos::extrapolation_t & extrapolation,
                              tchecker::zg_compos::incoming_edges_value_t const & edges);
...
inline tchecker::state_status_t prev(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                     tchecker::zg::transition_t & t, tchecker::zg::semantics_t & semantics,
                                     tchecker::zg_compos::extrapolation_t & extrapolation,
                                     tchecker::zg_compos::incoming_edges_value_t const & v)
{
  return tchecker::zg_compos::prev(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
                            t.guard_container(), t.reset_container(), t.tgt_invariant_container(), semantics, extrapolation, v);
}
...
inline tchecker::state_status_t initialize(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                           ...
                                           std::map<std::string, std::string> const & attributes)
{
  return tchecker::zg_compos::initialize(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(),
...
class zg_t final : public tchecker::ts::fwd_t<tchecker::zg::state_sptr_t, tchecker::zg::const_state_sptr_t,
                   ...
                   public tchecker::ts::fwd_impl_t<tchecker::zg::state_sptr_t, tchecker::zg::const_state_sptr_t,
                                                   tchecker::zg::transition_sptr_t, tchecker::zg::const_transition_sptr_t,
                                                   tchecker::zg_compos::initial_range_t, tchecker::zg_compos::outgoing_edges_range_t,
                                                   tchecker::zg_compos::initial_value_t, tchecker::zg_compos::outgoing_edges_value_t>,
                   public tchecker::ts::bwd_impl_t<tchecker::zg::state_sptr_t, tchecker::zg::const_state_sptr_t,
                                                   tchecker::zg::transition_sptr_t, tchecker::zg::const_transition_sptr_t,
                                                   tchecker::zg_compos::final_range_t, tchecker::zg_compos::incoming_edges_range_t,
                                                   tchecker::zg_compos::final_value_t, tchecker::zg_compos::incoming_edges_value_t>,
...
public:
   ...
   */
  zg_t(tchecker::zg_compos::zg_t const &) = delete;

  /*!
   \brief Move constructor (deleted)
   */
  zg_t(tchecker::zg_compos::zg_t &&) = delete;
   ...
   */
  tchecker::zg_compos::zg_t & operator=(tchecker::zg_compos::zg_t const &) = delete;

  /*!
   \brief Move-assignment operator (deleted)
   */
  tchecker::zg_compos::zg_t & operator=(tchecker::zg_compos::zg_t &&) = delete;
...
private:
  ...
  std::shared_ptr<tchecker::zg_compos::extrapolation_t> _extrapolation;   /*!< Zone extrapolation */
 ...
 */
tchecker::zg::state_sptr_t initial(tchecker::zg_compos::zg_t & zg, tchecker::vloc_t const & vloc,
                                   tchecker::state_status_t mask = tchecker::STATE_OK);
...
next(tchecker::zg_compos::zg_t & zg, tchecker::zg::const_state_sptr_t const & s, tchecker::vedge_t const & vedge,
     tchecker::state_status_t mask = tchecker::STATE_OK);
