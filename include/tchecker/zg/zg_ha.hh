 ...
 */
inline tchecker::zg_ha::initial_range_t initial_edges(tchecker::ta::system_t const & system)
{
...
inline tchecker::state_status_t initial(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                        ...
                                        tchecker::zg::extrapolation_t & extrapolation, tchecker::zg_ha::initial_value_t const & v)
{
  return tchecker::zg_ha::initial(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.sync_id(),
 ...
 */
inline tchecker::zg_ha::final_range_t final_edges(tchecker::ta::system_t const & system, boost::dynamic_bitset<> const & labels)
{
...
tchecker::state_status_t final(tchecker::ta::system_t const & system, tchecker::vloc_sptr_t const & vloc,
                               ...
                               tchecker::vedge_sptr_t const & vedge, tchecker::sync_id_t & sync_id,
                               tchecker::clock_constraint_container_t & invariant, tchecker::zg::semantics_t & semantics,
                               tchecker::zg::extrapolation_t & extrapolation, tchecker::zg_ha::final_value_t const & final_range);
...
inline tchecker::state_status_t final(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                      tchecker::zg::transition_t & t, tchecker::zg::semantics_t & semantics,
                                      tchecker::zg::extrapolation_t & extrapolation, tchecker::zg_ha::final_value_t const & v)
{
  return tchecker::zg_ha::final(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.sync_id(),
                             t.tgt_invariant_container(), semantics, extrapolation, v);
}
 ...
 */
inline tchecker::zg_ha::outgoing_edges_range_t outgoing_edges(tchecker::ta::system_t const & system,
...
tchecker::state_status_t next(tchecker::ta::system_t const & system, tchecker::vloc_sptr_t const & vloc,
                              ...
                              tchecker::zg::extrapolation_t & extrapolation,
                              tchecker::zg_ha::outgoing_edges_value_t const & sync_edges);
...
inline tchecker::state_status_t next(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                     ...
                                     tchecker::zg_ha::outgoing_edges_value_t const & sync_edges)
{
  auto result = tchecker::zg_ha::next(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.sync_id(),
  ...
  tchecker::edge_id_t eid = *(t.vedge_ptr()->begin());
  auto const & edge = system.edge(eid);
  std::string const & event_name = system.event_name(edge->event_id());
 ...
 */
inline tchecker::zg_ha::incoming_edges_range_t incoming_edges(tchecker::ta::system_t const & system,
                                                           tchecker::const_vloc_sptr_t const & vloc)
{
...
tchecker::state_status_t prev(tchecker::ta::system_t const & system, tchecker::vloc_sptr_t const & vloc,
                              ...
                              std::vector<std::pair<tchecker::variable_id_t, tchecker::variable_id_t>> & intvar_set,
                              tchecker::clock_constraint_container_t & tgt_invariant, tchecker::zg::semantics_t & semantics,
                              tchecker::zg::extrapolation_t & extrapolation, tchecker::zg_ha::incoming_edges_value_t const & v);
...
{
  return tchecker::zg_ha::prev(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.sync_id(),
                                   t.src_invariant_container(), t.guard_container(), t.intvar_guard_container(), t.reset_container(), t.intvar_set_container(), t.tgt_invariant_container(),
...
inline tchecker::state_status_t initialize(tchecker::ta::system_t const & system, tchecker::zg::state_t & s,
                                           ...
                                           std::map<std::string, std::string> const & attributes)
{
  return tchecker::zg_ha::initialize(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.sync_id(),
 ...
 */
tchecker::zg_ha::zg_t * factory(std::shared_ptr<tchecker::ta::system_t const> const & system,
