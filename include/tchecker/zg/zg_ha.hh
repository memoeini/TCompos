...
#ifndef TCHECKER_ZG_HA_HH
#define TCHECKER_ZG_HA_HH
...
#include "tchecker/zg/allocators_ha.hh"
#include "tchecker/zg/extrapolation_ha.hh"
 ...
 */
using initial_iterator_t = tchecker::ta_ha::initial_iterator_t;

/*!
\brief Type of range of iterators over inital states
*/
using initial_range_t = tchecker::ta_ha::initial_range_t;
 ...
 */
inline tchecker::zg_ha::initial_range_t initial_edges(tchecker::ta_ha::system_t const & system)
{
  return tchecker::ta_ha::initial_edges(system);
}

/*!
 \brief Dereference type for iterator over initial states
 */
using initial_value_t = tchecker::ta_ha::initial_value_t;
...
*/
inline tchecker::state_status_t initial(tchecker::ta_ha::system_t const & system, tchecker::zg::state_t & s,
                                        tchecker::zg_ha::transition_t & t, tchecker::zg::semantics_t & semantics,
                                        tchecker::zg_ha::extrapolation_t & extrapolation, tchecker::zg_ha::initial_value_t const & v)
{
  return tchecker::zg_ha::initial(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
 ...
 */
using final_iterator_t = tchecker::ta_ha::final_iterator_t;

/*!
\brief Type of range of iterators over final edges
*/
using final_range_t = tchecker::ta_ha::final_range_t;
 ...
 */
inline tchecker::zg_ha::final_range_t final_edges(tchecker::ta_ha::system_t const & system, boost::dynamic_bitset<> const & labels)
{
  return tchecker::ta_ha::final_edges(system, labels);
}

/*!
 \brief Dereference type for iterator over final edges
 */
using final_value_t = tchecker::ta_ha::final_value_t;
...
/*!
 ...
 \throw std::invalid_argument : if s and v have incompatible sizes
*/
inline tchecker::state_status_t final(tchecker::ta_ha::system_t const & system, tchecker::zg::state_t & s,
                                      tchecker::zg_ha::transition_t & t, tchecker::zg::semantics_t & semantics,
                                      tchecker::zg_ha::extrapolation_t & extrapolation, tchecker::zg_ha::final_value_t const & v)
{
  return tchecker::zg_ha::final(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
                             semantics, extrapolation, v);
}
 ...
 */
using outgoing_edges_iterator_t = tchecker::ta_ha::outgoing_edges_iterator_t;

/*!
\brief Type of range of outgoing edges
*/
using outgoing_edges_range_t = tchecker::ta_ha::outgoing_edges_range_t;
 ...
 */
inline tchecker::zg_ha::outgoing_edges_range_t
outgoing_edges(tchecker::ta_ha::system_t const & system,
               tchecker::intrusive_shared_ptr_t<tchecker::shared_vloc_t const> const & vloc)
{
  return tchecker::ta_ha::outgoing_edges(system, vloc);
}

/*!
 \brief Type of outgoing vedge (range of synchronized/asynchronous edges)
 */
using outgoing_edges_value_t = tchecker::ta_ha::outgoing_edges_value_t;
...
tchecker::state_status_t next(tchecker::ta_ha::system_t const & system,
                              ...
                              tchecker::zg_ha::extrapolation_t & extrapolation,
                              tchecker::zg_ha::outgoing_edges_value_t const & edges);
...
*/
inline tchecker::state_status_t next(tchecker::ta_ha::system_t const & system, tchecker::zg::state_t & s,
                                     tchecker::zg_ha::transition_t & t, tchecker::zg::semantics_t & semantics,
                                     tchecker::zg_ha::extrapolation_t & extrapolation,
                                     tchecker::zg_ha::outgoing_edges_value_t const & v)
{
  return tchecker::zg_ha::next(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
                            t.guard_container(), t.intvar_guard_container(), t.reset_container(), t.intvar_set_container(), t.tgt_invariant_container(), semantics, extrapolation, v);
}
 ...
 */
using incoming_edges_iterator_t = tchecker::ta_ha::incoming_edges_iterator_t;

/*!
\brief Type of range of incoming edges
*/
using incoming_edges_range_t = tchecker::ta_ha::incoming_edges_range_t;
 ...
 */
inline tchecker::zg_ha::incoming_edges_range_t
incoming_edges(tchecker::ta_ha::system_t const & system,
               tchecker::intrusive_shared_ptr_t<tchecker::shared_vloc_t const> const & vloc)
{
  return tchecker::ta_ha::incoming_edges(system, vloc);
}

/*!
 \brief Type of incoming tuple of edges (range of synchronized/asynchronous edges)
 */
using incoming_edges_value_t = tchecker::ta_ha::incoming_edges_value_t;
...
tchecker::state_status_t prev(tchecker::ta_ha::system_t const & system,
                              ...
                              tchecker::clock_constraint_container_t & tgt_invariant, tchecker::zg::semantics_t & semantics,
                              tchecker::zg_ha::extrapolation_t & extrapolation,
                              tchecker::zg_ha::incoming_edges_value_t const & edges);
...
/*!
 ...
 \throw std::invalid_argument : if s and v have incompatible size
*/
inline tchecker::state_status_t prev(tchecker::ta_ha::system_t const & system, tchecker::zg::state_t & s,
                                     tchecker::zg_ha::transition_t & t, tchecker::zg::semantics_t & semantics,
                                     tchecker::zg_ha::extrapolation_t & extrapolation,
                                     tchecker::zg_ha::incoming_edges_value_t const & v)
{
  return tchecker::zg_ha::prev(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(), t.src_invariant_container(),
                            t.guard_container(), t.intvar_guard_container(), t.reset_container(), t.intvar_set_container(), t.tgt_invariant_container(), semantics, extrapolation, v);
}
...
*/
bool is_valid_final(tchecker::ta_ha::system_t const & system, tchecker::zg::state_t const & s);
...
/*!
 ...
 vloc is empty
*/
inline tchecker::state_status_t initialize(tchecker::ta_ha::system_t const & system, tchecker::zg::state_t & s,
                                           tchecker::zg_ha::transition_t & t,
                                           std::map<std::string, std::string> const & attributes)
{
  return tchecker::zg_ha::initialize(system, s.vloc_ptr(), s.intval_ptr(), s.zone_ptr(), t.vedge_ptr(),
...
class zg_t final : public tchecker::ts::fwd_t<tchecker::zg::state_sptr_t, tchecker::zg::const_state_sptr_t,
                                              tchecker::zg_ha::transition_sptr_t, tchecker::zg_ha::const_transition_sptr_t>,
                   ...
                   public tchecker::ts::fwd_impl_t<tchecker::zg::state_sptr_t, tchecker::zg::const_state_sptr_t,
                                                   tchecker::zg_ha::transition_sptr_t, tchecker::zg_ha::const_transition_sptr_t,
                                                   tchecker::zg_ha::initial_range_t, tchecker::zg_ha::outgoing_edges_range_t,
                                                   tchecker::zg_ha::initial_value_t, tchecker::zg_ha::outgoing_edges_value_t>,
                   public tchecker::ts::bwd_impl_t<tchecker::zg::state_sptr_t, tchecker::zg::const_state_sptr_t,
                                                   tchecker::zg_ha::transition_sptr_t, tchecker::zg_ha::const_transition_sptr_t,
                                                   tchecker::zg_ha::final_range_t, tchecker::zg_ha::incoming_edges_range_t,
                                                   tchecker::zg_ha::final_value_t, tchecker::zg_ha::incoming_edges_value_t>,
                   public tchecker::ts::builder_t<tchecker::zg::state_sptr_t, tchecker::zg_ha::transition_sptr_t>,
                   public tchecker::ts::inspector_t<tchecker::zg::const_state_sptr_t, tchecker::zg_ha::const_transition_sptr_t>,
                   public tchecker::ts::sharing_t<tchecker::zg::state_sptr_t, tchecker::zg_ha::transition_sptr_t> {
...
public:
  ...
  using bwd_impl_t = tchecker::ts::bwd_impl_t<tchecker::zg::state_sptr_t, tchecker::zg::const_state_sptr_t,
                                              ...
                                              tchecker::zg_ha::final_range_t, tchecker::zg_ha::incoming_edges_range_t,
                                              tchecker::zg_ha::final_value_t, tchecker::zg_ha::incoming_edges_value_t>;
  using builder_t = tchecker::ts::builder_t<tchecker::zg::state_sptr_t, tchecker::zg_ha::transition_sptr_t>;
  using inspector_t = tchecker::ts::inspector_t<tchecker::zg::const_state_sptr_t, tchecker::zg_ha::const_transition_sptr_t>;
  using sharing_t = tchecker::ts::sharing_t<tchecker::zg::state_sptr_t, tchecker::zg_ha::transition_sptr_t>;
   ...
   */
  zg_t(std::shared_ptr<tchecker::ta_ha::system_t const> const & system, enum tchecker::ts::sharing_type_t sharing_type,
   ...
   */
  zg_t(tchecker::zg_ha::zg_t const &) = delete;

  /*!
   \brief Move constructor (deleted)
   */
  zg_t(tchecker::zg_ha::zg_t &&) = delete;
   ...
   */
  tchecker::zg_ha::zg_t & operator=(tchecker::zg_ha::zg_t const &) = delete;

  /*!
   \brief Move-assignment operator (deleted)
   */
  tchecker::zg_ha::zg_t & operator=(tchecker::zg_ha::zg_t &&) = delete;
  ...
  */
   ...
   */
  virtual void attributes(tchecker::zg_ha::const_transition_sptr_t const & t, std::map<std::string, std::string> & m) const;
  ...
  */
  virtual void share(tchecker::zg_ha::transition_sptr_t & t);

  /*!
   \brief Accessor
   \return Pointer to underlying system of timed processes
  */
  inline std::shared_ptr<tchecker::ta_ha::system_t const> system_ptr() const { return _system; }

  /*!
   \brief Accessor
   \return Underlying system of timed processes
   */
  inline tchecker::ta_ha::system_t const & system() const { return *_system; }
...
private:
  ...
  std::shared_ptr<tchecker::ta_ha::system_t const> _system;           /*!< System of timed processes */
  ...
  std::shared_ptr<tchecker::zg_ha::extrapolation_t> _extrapolation;   /*!< Zone extrapolation */
  tchecker::zg_ha::state_pool_allocator_t _state_allocator;           /*!< Pool allocator of states */
  tchecker::zg_ha::transition_pool_allocator_t _transition_allocator; /*! Pool allocator of transitions */
};
 ...
 */
tchecker::zg::state_sptr_t initial(tchecker::zg_ha::zg_t & zg, tchecker::vloc_t const & vloc,
                                   tchecker::state_status_t mask = tchecker::STATE_OK);
 ...
 */
std::tuple<tchecker::zg::state_sptr_t, tchecker::zg_ha::transition_sptr_t>
next(tchecker::zg_ha::zg_t & zg, tchecker::zg::const_state_sptr_t const & s, tchecker::vedge_t const & vedge,
     tchecker::state_status_t mask = tchecker::STATE_OK);
