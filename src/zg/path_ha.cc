...
int lexical_cmp(tchecker::zg_ha::path::symbolic::node_t const & n1, tchecker::zg_ha::path::symbolic::node_t const & n2)
{
...
edge_t::edge_t(tchecker::zg_ha::const_transition_sptr_t const & t) : _t(t) {}

edge_t::edge_t(tchecker::zg_ha::transition_sptr_t const & t) : _t(t) {}

edge_t::edge_t(tchecker::zg_ha::path::symbolic::edge_t const & e) : _t(e._t) {}

edge_t::edge_t(tchecker::zg_ha::path::symbolic::edge_t && e) : _t(std::move(e._t)) {}

tchecker::zg_ha::path::symbolic::edge_t & edge_t::operator=(tchecker::zg_ha::path::symbolic::edge_t const & e)
{
  if (this != &e)
    _t = e._t;
  return *this;
...
tchecker::zg_ha::path::symbolic::edge_t & edge_t::operator=(tchecker::zg_ha::path::symbolic::edge_t && e)
{
  if (this != &e)
    _t = std::move(e._t);
  return *this;
...
int lexical_cmp(tchecker::zg_ha::path::symbolic::edge_t const & e1, tchecker::zg_ha::path::symbolic::edge_t const & e2)
{
  return tchecker::zg_ha::lexical_cmp(e1.transition(), e2.transition()) < 0;
}

/* finite_path_t */

void finite_path_t::attributes(tchecker::zg_ha::path::symbolic::node_t const & n, std::map<std::string, std::string> & m) const
{
  tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                              tchecker::zg_ha::path::symbolic::edge_t>::attributes(n, m);
  if (n.initial())
    m["initial"] = "true";
  if (n.final())
    m["final"] = "true";
...
void finite_path_t::attributes(tchecker::zg_ha::path::symbolic::edge_t const & e, std::map<std::string, std::string> & m) const
{
  tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                              tchecker::zg_ha::path::symbolic::edge_t>::attributes(e, m);
}
...
class node_le_t {
public:
  bool operator()(tchecker::zg_ha::path::symbolic::finite_path_t::node_sptr_t const & n1,
                  tchecker::zg_ha::path::symbolic::finite_path_t::node_sptr_t const & n2) const
  {
    return tchecker::zg_ha::path::symbolic::lexical_cmp(static_cast<tchecker::zg_ha::path::symbolic::node_t const &>(*n1),
                                                     static_cast<tchecker::zg_ha::path::symbolic::node_t const &>(*n2)) < 0;
  }
};
...
class edge_le_t {
public:
  bool operator()(tchecker::zg_ha::path::symbolic::finite_path_t::edge_sptr_t const & e1,
                  tchecker::zg_ha::path::symbolic::finite_path_t::edge_sptr_t const & e2) const
  {
    return tchecker::zg_ha::path::symbolic::lexical_cmp(static_cast<tchecker::zg_ha::path::symbolic::edge_t const &>(*e1),
                                                     static_cast<tchecker::zg_ha::path::symbolic::edge_t const &>(*e2)) < 0;
  }
};

std::ostream & dot_output(std::ostream & os, tchecker::zg_ha::path::symbolic::finite_path_t const & path, std::string const & name)
{
  return tchecker::graph::dot_output<tchecker::zg_ha::path::symbolic::finite_path_t, tchecker::zg_ha::path::symbolic::node_le_t,
                                     tchecker::zg_ha::path::symbolic::edge_le_t>(os, path, name);
}

/* finite path computation */

tchecker::zg_ha::path::symbolic::finite_path_t * compute_finite_path(std::shared_ptr<tchecker::zg_ha::zg_t> const & zg,
                                                                  tchecker::vloc_t const & initial_vloc,
                                                                  std::vector<tchecker::const_vedge_sptr_t> const & seq,
                                                                  bool last_node_final)
{
  tchecker::zg_ha::path::symbolic::finite_path_t * path = new tchecker::zg_ha::path::symbolic::finite_path_t{zg};

  tchecker::zg::const_state_sptr_t s{tchecker::zg_ha::initial(*zg, initial_vloc)};
  if (s.ptr() == nullptr) {
    delete path;
  ...
  for (tchecker::const_vedge_sptr_t const & vedge_ptr : seq) {
    ...
    auto && [nexts, nextt] = tchecker::zg_ha::next(*zg, s, *vedge_ptr);
...
void lasso_path_t::attributes(tchecker::zg_ha::path::symbolic::node_t const & n, std::map<std::string, std::string> & m) const
{
  tchecker::ts::lasso_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                             tchecker::zg_ha::path::symbolic::edge_t>::attributes(n, m);
  if (n.initial())
    m["initial"] = "true";
  if (n.final())
...
void lasso_path_t::attributes(tchecker::zg_ha::path::symbolic::edge_t const & e, std::map<std::string, std::string> & m) const
{
  tchecker::ts::lasso_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::symbolic::node_t,
                             tchecker::zg_ha::path::symbolic::edge_t>::attributes(e, m);
}
...
std::ostream & dot_output(std::ostream & os, tchecker::zg_ha::path::symbolic::lasso_path_t const & path, std::string const & name)
{
  return tchecker::graph::dot_output<tchecker::zg_ha::path::symbolic::lasso_path_t, tchecker::zg_ha::path::symbolic::node_le_t,
                                     tchecker::zg_ha::path::symbolic::edge_le_t>(os, path, name);
}

/* lasso path computation */

tchecker::zg_ha::path::symbolic::lasso_path_t *
compute_lasso_path(std::shared_ptr<tchecker::zg_ha::zg_t> const & zg, tchecker::vloc_t const & initial_vloc,
                   ...
                   std::function<bool(tchecker::zg::state_t const &)> && final_state)
{
  ...
  tchecker::zg_ha::path::symbolic::lasso_path_t * path = new tchecker::zg_ha::path::symbolic::lasso_path_t{zg};
  ...
  // compute cycle
  s = path->loop_root()->state_ptr();
  std::vector<std::tuple<tchecker::zg_ha::transition_sptr_t, tchecker::zg::state_sptr_t>> args;
  for (std::size_t i = 0; i < cycle.size() - 1; ++i) {
    auto && [nexts, nextt] = tchecker::zg_ha::next(*zg, s, *cycle[i]);
    if (nexts.ptr() == nullptr || nextt.ptr() == nullptr) {
      delete path;
      throw std::invalid_argument("*** compute_lasso_path: prefix is not feasible from given initial locations");
    }
  ...
  auto && [nexts, nextt] = tchecker::zg_ha::next(*zg, s, *cycle.back());
  if (nexts.ptr() == nullptr || nextt.ptr() == nullptr) {
    delete path;
    throw std::invalid_argument("*** compute_lasso_path: prefix is not feasible from given initial locations");
  }
...
node_t::node_t(tchecker::zg::state_sptr_t const & s, tchecker::clockval_sptr_t const & clockval, bool initial, bool final)
    : tchecker::zg_ha::path::symbolic::node_t(s, initial, final), _clockval(clockval)
{
...
int lexical_cmp(tchecker::zg_ha::path::concrete::node_t const & n1, tchecker::zg_ha::path::concrete::node_t const & n2)
{
  int cmp = tchecker::zg_ha::path::symbolic::lexical_cmp(n1, n2);
  if (cmp != 0)
    return cmp;
...
edge_t::edge_t(tchecker::zg_ha::const_transition_sptr_t const & t, tchecker::clock_rational_value_t delay)
    : tchecker::zg_ha::path::symbolic::edge_t(t), _delay(delay)
{
  if (delay < 0)
    throw std::invalid_argument("negative delay is not allowed");
}

edge_t::edge_t(tchecker::zg_ha::transition_sptr_t const & t, tchecker::clock_rational_value_t delay)
    : tchecker::zg_ha::path::symbolic::edge_t(t), _delay(delay)
{
  if (delay < 0)
    throw std::invalid_argument("negative delay is not allowed");
...
edge_t::edge_t(std::tuple<tchecker::zg_ha::const_transition_sptr_t, tchecker::clock_rational_value_t> const & t)
    : edge_t(std::get<0>(t), std::get<1>(t))
{
}

edge_t::edge_t(std::tuple<tchecker::zg_ha::transition_sptr_t, tchecker::clock_rational_value_t> const & t)
    : edge_t(std::get<0>(t), std::get<1>(t))
{
}

int lexical_cmp(tchecker::zg_ha::path::concrete::edge_t const & e1, tchecker::zg_ha::path::concrete::edge_t const & e2)
{
  int cmp = tchecker::zg_ha::path::symbolic::lexical_cmp(e1, e2);
  if (cmp != 0)
    return cmp;
...
finite_path_t::finite_path_t(std::shared_ptr<tchecker::zg_ha::zg_t> const & zg, std::size_t clockval_alloc_nb)
    : tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::concrete::node_t,
                                  tchecker::zg_ha::path::concrete::edge_t>::finite_path_t(zg),
...
{
  tchecker::graph::finite_path_t<tchecker::zg_ha::path::concrete::node_t, tchecker::zg_ha::path::concrete::edge_t>::clear();
                                   ...
                                   bool initial, bool final)
{
  ...
  tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::concrete::node_t,
                              tchecker::zg_ha::path::concrete::edge_t>::add_first_node(std::make_tuple(s, clockval_sptr, initial,
                                                                                                    final));
}

void finite_path_t::extend_back(tchecker::zg_ha::const_transition_sptr_t const & t, tchecker::clock_rational_value_t delay,
                                tchecker::zg::const_state_sptr_t const & s, tchecker::clockval_t const & clockval, bool initial,
                                bool final)
{
  tchecker::const_clockval_sptr_t clockval_sptr{_clockval_pool.construct(clockval)};
  tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::concrete::node_t,
                              tchecker::zg_ha::path::concrete::edge_t>::extend_back(std::make_tuple(t, delay),
                                                                                 std::make_tuple(s, clockval_sptr, initial,
                                                                                                 final));
}

void finite_path_t::extend_front(tchecker::zg_ha::const_transition_sptr_t const & t, tchecker::clock_rational_value_t delay,
                                 tchecker::zg::const_state_sptr_t const & s, tchecker::clockval_t const & clockval,
                                 bool initial, bool final)
{
  tchecker::const_clockval_sptr_t clockval_sptr{_clockval_pool.construct(clockval)};
  tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::concrete::node_t,
                              tchecker::zg_ha::path::concrete::edge_t>::extend_front(std::make_tuple(t, delay),
                                                                                  std::make_tuple(s, clockval_sptr, initial,
                                                                                                  final));
}

void finite_path_t::attributes(tchecker::zg_ha::path::concrete::node_t const & n, std::map<std::string, std::string> & m) const
{
  tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::concrete::node_t,
                              tchecker::zg_ha::path::concrete::edge_t>::attributes(n, m);
  if (n.initial())
    m["initial"] = "true";
  if (n.final())
    m["final"] = "true";
...
void finite_path_t::attributes(tchecker::zg_ha::path::concrete::edge_t const & e, std::map<std::string, std::string> & m) const
{
  tchecker::ts::finite_path_t<tchecker::zg_ha::zg_t, tchecker::zg_ha::path::concrete::node_t,
                              tchecker::zg_ha::path::concrete::edge_t>::attributes(e, m);
...
class node_le_t {
public:
  bool operator()(tchecker::zg_ha::path::concrete::finite_path_t::node_sptr_t const & n1,
                  tchecker::zg_ha::path::concrete::finite_path_t::node_sptr_t const & n2) const
  {
    return tchecker::zg_ha::path::concrete::lexical_cmp(static_cast<tchecker::zg_ha::path::concrete::node_t const &>(*n1),
                                                     static_cast<tchecker::zg_ha::path::concrete::node_t const &>(*n2)) < 0;
  }
};
...
class edge_le_t {
public:
  bool operator()(tchecker::zg_ha::path::concrete::finite_path_t::edge_sptr_t const & e1,
                  tchecker::zg_ha::path::concrete::finite_path_t::edge_sptr_t const & e2) const
  {
    return tchecker::zg_ha::path::concrete::lexical_cmp(static_cast<tchecker::zg_ha::path::concrete::edge_t const &>(*e1),
                                                     static_cast<tchecker::zg_ha::path::concrete::edge_t const &>(*e2)) < 0;
  }
};

std::ostream & dot_output(std::ostream & os, tchecker::zg_ha::path::concrete::finite_path_t const & path, std::string const & name)
{
  return tchecker::graph::dot_output<tchecker::zg_ha::path::concrete::finite_path_t, tchecker::zg_ha::path::concrete::node_le_t,
                                     tchecker::zg_ha::path::concrete::edge_le_t>(os, path, name);
}
...
public:
  ...
  */
  clockval_dbm_t(tchecker::zg_ha::path::concrete::clockval_dbm_t const & cvdbm)
  ...
  */
  clockval_dbm_t(tchecker::zg_ha::path::concrete::clockval_dbm_t && cvdbm)
  ...
  */
  tchecker::zg_ha::path::concrete::clockval_dbm_t & operator=(tchecker::zg_ha::path::concrete::clockval_dbm_t const & cvdbm)
  {
    if (&cvdbm != this) {
      if (_dim != cvdbm._dim) {
        delete[] _dbm;
  ...
  */
  tchecker::zg_ha::path::concrete::clockval_dbm_t & operator=(tchecker::zg_ha::path::concrete::clockval_dbm_t && cvdbm)
  {
    if (&cvdbm != this) {
  ...
  */
  tchecker::state_status_t prev(tchecker::zg_ha::transition_t const & t, bool src_delay_allowed, bool tgt_delay_allowed,
...
tchecker::zg_ha::path::concrete::finite_path_t *
compute_finite_path(tchecker::zg_ha::path::symbolic::finite_path_t const & symbolic_run)
{
  tchecker::zg_ha::path::concrete::finite_path_t * concrete_run =
      new tchecker::zg_ha::path::concrete::finite_path_t{symbolic_run.zg_ptr(), 1024};

  tchecker::zg_ha::path::symbolic::finite_path_t::node_sptr_t const first_symbolic_node{symbolic_run.first()};
  tchecker::zg_ha::path::symbolic::finite_path_t::node_sptr_t symbolic_node{symbolic_run.last()};

  tchecker::zg_ha::path::concrete::clockval_dbm_t clockval_dbm{
  ...
  do {
    ...
    bool tgt_delay_allowed = tchecker::ta_ha::delay_allowed(symbolic_run.zg().system(), symbolic_node->state().vloc());

    tchecker::zg_ha::path::symbolic::finite_path_t::edge_sptr_t symbolic_edge = symbolic_run.incoming_edge(symbolic_node);
    symbolic_node = symbolic_run.edge_src(symbolic_edge);

    bool src_delay_allowed = tchecker::ta_ha::delay_allowed(symbolic_run.zg().system(), symbolic_node->state().vloc());
